...
/**
 * Load Tailwind and Fonts for Interactive Cybersecurity Plan
 */
 function enqueue_cysec_plan_assets() {
    if (is_page_template('CySecInteractivePlan.php')) {
...
add_action('wp_enqueue_scripts', 'enqueue_cysec_plan_assets');
